    ...
    <div class="container">
        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-7">
                ...
                <div class="row mb-3">
                    <div class="col-sm-6 py-2"><h6>Name: <span class="text-secondary">Lakshan Rajapaksha</span></h6></div>
                    <div class="col-sm-6 py-2"><h6>Birthday: <span class="text-secondary">14 Feb 2000</span></h6></div>
                    ...
                    <div class="col-sm-6 py-2"><h6>Phone: <span class="text-secondary">+077 273 8668</span></h6></div>
                    <div class="col-sm-6 py-2"><h6>Email: <span class="text-secondary">lrajapaksha58@gmail.com</span></h6></div>
                    <div class="col-sm-6 py-2"><h6>Address: <span class="text-secondary">galgamwa, Kurunegala, Sri Lanka</span></h6></div>
